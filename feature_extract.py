...
sys.path.append(os.path.dirname(os.path.realpath(__file__)) + '/lib')
sys.path.append('/home/chelsea/PycharmProjects/phishing/scripts_m1/Gibberish-Detector')
# import gib_score
...
keyword_file = '/home/chelsea/PycharmProjects/phishing/data/keywords.csv'
...
top_brand_list = []
brands_file = '/home/chelsea/PycharmProjects/phishing/data/top_brands.csv'
...
benign_dom_list = []
benign_site_file = '/var/tmp/chelsea/benign_train.txt'
