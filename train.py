...
record_limit = 2000
data_dir = '/var/tmp/phishing/scripts_m1/data/'


mal_dir = '/var/tmp/phishing/out/ph_updated_src/'
benign_dir = '/var/tmp/phishing/out/bn_updated_src_a/'
...
def generate_data():
    benign = open("/var/tmp/phishing/benign_train.txt", "r")
    phishing = open("/var/tmp/phishing/phishing_train.txt", "r")

    timeout_val = 10
    # delete data files
    delete_file(data_dir + 'X.txt') # /var/tmp/phishing/scripts_m1/data/X.txt
    delete_file(data_dir + 'Y.txt') # /var/tmp/phishing/scripts_m1/data/Y.txt
